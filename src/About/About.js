      ...
      <div className="container">
        <div className="row">
          <div className="section-head col-sm-12">
            ...
            <p>When you choose us, you'll feel the benefit of 5 years' experience of Travel Agency. </p>
          </div>
          <div className="col-lg-4 col-sm-6">
            <div className="item"> <span className="icon feature_box_col_one"><i className="fa fa-globe"></i></span>
              <h6>App Based Guiding System</h6>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="item"> <span className="icon feature_box_col_four"><i className="fa fa-database"></i></span>
              <h6>Data Privary</h6>
              <p>All our data is encrypted and connetion are secured with SSL certificat. Your personal and payment data are safe to us.</p>
            </div>
          </div>
          <div className="col-lg-4 col-sm-6">
